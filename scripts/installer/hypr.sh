...
run_command "mkdir -p /home/$SUDO_USER/.config/hypr/ && cp -r /home/$SUDO_USER/hypr/configs/hypr/hyprland.conf /home/$SUDO_USER/.config/hypr/" "Copy hyprland config (Must)" "yes" "no" 
...
run_command "cp -r /home/$SUDO_USER/hypr/configs/dunst /home/$SUDO_USER/.config/" "Copy dunst config" "yes" "no"
